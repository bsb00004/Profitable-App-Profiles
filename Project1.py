...
# 
# In Example below we can find the the corrosponting number of the character.

#print(ord('剧'))#commented by default to avoid run error.
print(ord('a'))
print(ord('A'))
print(ord('+'))
print(ord('5'))
...
# The function seems to work fine, but some English app names use emojis or other symbols (™, — (em dash), – (en dash), etc.) that fall outside of the ASCII range. Because of this, we'll remove useful apps if we use the function in its current form and have corresponding numbers over 127.

print(is_english('Docs To Go™ Free Office Suite'))
print(is_english('Instachat 😜'))

#print(ord('™'))#commented by default to avoid run error.
#print(ord('😜'))#commented by default to avoid run error.
